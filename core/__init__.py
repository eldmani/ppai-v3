...
"""Core mathematical components: projection, optimization, activation specs."""

from .projection import ProjectionSpec, build_ppt_projection, build_projection_from_spec
from .optimize import find_optimal_spec, find_optimal_angles
from .spec import get_activation, ACTIVATION_SPECS, NORM_SPECS
